let roundLocked = false;
  ...
  function randomItem(transformedCoordinates){
    return transformedCoordinates[Math.floor(Math.random()*transformedCoordinates.length)];
  }
  
  function mainFunction(){
    targetPos = randomItem(transformedCoordinates);
